...
To train our YOLO detector, we first annotate images located in [`TrainYourOwnYOLO/Data/Source_Images`](/Data/Source_Images) with the help of Microsoft's Visual Object Tagging Tool (VoTT). [[Make note on using your own dataset]] For decent results annotate at least 100 images - the more the better!
